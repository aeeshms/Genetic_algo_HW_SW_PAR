...
%=========================================================================
deadline=input('enter cost deadline: ');
...
% %            time4=time4+input_mat(j,2*random_population4(i,j)+2);
      ...
      tot_cost(4,i)=cost4;
      if(cost1>deadline)
          fitness_value(1,i)=1000*(cost1-deadline)+time1;
      else
          fitness_value(1,i)=time1;
      end
      if(cost2>deadline)
          fitness_value(2,i)=1000*(cost2-deadline)+time2;
      else
          fitness_value(2,i)=time2;
      end
      if(cost3>deadline)
          fitness_value(3,i)=1000*(cost3-deadline)+time3;
      else
          fitness_value(3,i)=time3;
      end
      if(cost4>deadline)
          fitness_value(4,i)=1000*(cost4-deadline)+time4;
      else
          fitness_value(4,i)=time4;
      end
 end
...
for s=1:4
  ...
  location=min(loc);
  final_cost(s,l)=tot_cost(s,location);
  if(s==1)
